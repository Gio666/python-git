...
def agregarAlArbol():
    ...
    global cedula, nombre, mama, papa, arbol, cabezaDeFecha
    ...
    arbol.add_edge(union, nombre, arrowhead = cabezaDeFecha)
...
nodo = arbol.get_node(nombre)
nodo.attr['label']='circle'
dibuje()
#for x in range(0, 2):
