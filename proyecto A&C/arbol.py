...
def dibuje(arbol):
    ...
    print "Escribiendo archivo .dot para Graphviz"
    arbol.write('ancestros.dot') # write to simple.dot
    
    B=pgv.AGraph('ancestros.dot') # create a new graph from file
    B.layout(prog='dot') # layout with default (neato)
    nombreDeArchivo = 'ancestros.png'
    
    print "Escribiendo archivo de imagen"
...
def hacerArbol(lista):
    ...
    arbol.graph_attr['label']='Ancestros de ' + lista[1].split()[0].capitalize()
